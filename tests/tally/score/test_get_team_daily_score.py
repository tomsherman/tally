...
class TestGetTeamDailyScore:
    ...
    def test_empty_user_daily_scores_returns_empty_list(
    ...
    def test_complex_scenario_multiple_teams_multiple_dates(
        self, mock_db, init_teams_and_users
    ):
    ...
    def test_user_not_in_users_list_creates_team_mapping(
        self, mock_db, init_teams_and_users
    ):
    ...
    def test_team_daily_score_aggregation_and_bonus_calculation(
        self, mock_db, init_teams_and_users
    ):
