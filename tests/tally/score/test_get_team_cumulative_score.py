...
from tally.actions.score.team_score import get_team_cumulative_score, TeamDailyScore, TeamCumulativeScore
...
class TestGetTeamCumulativeScore:
    ...
    def test_single_team_single_daily_score(self, mock_db, init_teams_and_users):
        ...
        team_daily_score = TeamDailyScore(team=team1, date=date(2023, 1, 15), users=[user1])
    ...
    def test_single_team_multiple_daily_scores(self, mock_db, init_teams_and_users):
        ...
        team_daily_score1 = TeamDailyScore(team=team1, date=date(2023, 1, 15), users=users)
        team_daily_score1.add_user_score(UserDailyScore(user=user1, date=date(2023, 1, 15), points=10))
        team_daily_score1.add_user_score(UserDailyScore(user=user2, date=date(2023, 1, 15), points=15))
        
        # Day 2: Only one user active
        team_daily_score2 = TeamDailyScore(team=team1, date=date(2023, 1, 16), users=users)
        team_daily_score2.add_user_score(UserDailyScore(user=user1, date=date(2023, 1, 16), points=8))
        ...
        expected_points = team_daily_score1.get_points() + team_daily_score2.get_points()
    ...
    def test_multiple_teams_with_daily_scores(self, mock_db, init_teams_and_users):
        ...
        team1_day1 = TeamDailyScore(team=team1, date=date(2023, 1, 15), users=[user1, user2])
        team1_day1.add_user_score(UserDailyScore(user=user1, date=date(2023, 1, 15), points=10))
        team1_day1.add_user_score(UserDailyScore(user=user2, date=date(2023, 1, 15), points=15))
        
        team1_day2 = TeamDailyScore(team=team1, date=date(2023, 1, 16), users=[user1, user2])
        team1_day2.add_user_score(UserDailyScore(user=user1, date=date(2023, 1, 16), points=12))
        
        # Team2: Single day, single user
        team2_day1 = TeamDailyScore(team=team2, date=date(2023, 1, 15), users=[user3])
        team2_day1.add_user_score(UserDailyScore(user=user3, date=date(2023, 1, 15), points=20))
    ...
    def test_teams_sorted_by_points_descending(self, mock_db, init_teams_and_users):
        ...
        team1_day1 = TeamDailyScore(team=team1, date=date(2023, 1, 15), users=[user1, user2])
        team1_day1.add_user_score(UserDailyScore(user=user1, date=date(2023, 1, 15), points=5))
        
        # Team2: High score (25 base points + 5 bonus since all users active = 30)
        team2_day1 = TeamDailyScore(team=team2, date=date(2023, 1, 15), users=[user3])
        team2_day1.add_user_score(UserDailyScore(user=user3, date=date(2023, 1, 15), points=25))
        ...
        team3_day1.add_user_score(UserDailyScore(user=user4, date=date(2023, 1, 15), points=15))
    ...
    def test_teams_with_equal_points_maintain_stable_sort(self, mock_db, init_teams_and_users):
        ...
        team2_day1 = TeamDailyScore(team=team2, date=date(2023, 1, 15), users=[user3])
        team2_day1.add_user_score(UserDailyScore(user=user3, date=date(2023, 1, 15), points=10))
    ...
    def test_duplicate_team_daily_scores_accumulate_correctly(self, mock_db, init_teams_and_users):
        ...
        team_daily_score1 = TeamDailyScore(team=team1, date=date(2023, 1, 15), users=[user1])
        team_daily_score1.add_user_score(UserDailyScore(user=user1, date=date(2023, 1, 15), points=10))
        
        team_daily_score2 = TeamDailyScore(team=team1, date=date(2023, 1, 16), users=[user1])
        team_daily_score2.add_user_score(UserDailyScore(user=user1, date=date(2023, 1, 16), points=15))
        
        team_daily_score3 = TeamDailyScore(team=team1, date=date(2023, 1, 17), users=[user1])
        team_daily_score3.add_user_score(UserDailyScore(user=user1, date=date(2023, 1, 17), points=8))
    ...
    def test_team_in_daily_scores_not_in_users_list(self, mock_db, init_teams_and_users):
